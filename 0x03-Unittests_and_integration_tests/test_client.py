...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos_url(self):
        ...
        with patch.object(GithubOrgClient, 'org', new=PropertyMock) as mock_org:
    ...
    def test_public_repos(self, mock):
        ...
        mock.return_value = fake_repos_payload

        test_url = "https://api.github.com/orgs/test-org/repos"

        with patch.object(GithubOrgClient, "_public_repos_url", new=PropertyMock) as mock_url:
